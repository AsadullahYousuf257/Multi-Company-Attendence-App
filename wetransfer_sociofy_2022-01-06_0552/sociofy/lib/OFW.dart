...
class OFW extends StatefulWidget {
  @override
...
class _State extends State<OFW> {
        ...
        child: ListView(
          children: <Widget>[
            Container(
              ...
              child: SizedBox(
                child: Image.asset("images/Group 101.jpg"),
              ),
            ),
            Container(
              width: 500,
              ...
              child: Column(
                ...
                children: [
                  Container(
                      child: SizedBox(
                    width: 150,
                    child: Image.asset("images/Ofw logistic logo file-01.png"),
                  )),
                  Padding(
                    ...
                    child: Ink(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [Color(0xffF27728), Color(0xffDA5100)],
