...
void main() =>
    MaterialApp(home: signup_sociofy(), debugShowCheckedModeBanner: false);

class signup_sociofy extends StatefulWidget {
  @override
  _signup_sociofyState createState() => _signup_sociofyState();
}

class _signup_sociofyState extends State<signup_sociofy> {
  // String attachment;
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Center(
                      child: Image.asset("images/Group 91.jpg"),
                    ),
                  ),
                  Container(
                    width: 500,
                          ...
                          child: Ink(
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Color(0xff000000), Color(0xff484543)],
